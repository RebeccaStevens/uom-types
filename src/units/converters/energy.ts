 ...
 */
export function jouleToWattMinute(energy: Joule): WattMinute {
 ...
 */
export function jouleToWattHour(energy: Joule): WattHour {
 ...
 */
export function wattMinuteToJoule(energy: WattMinute): Joule {
 ...
 */
export function wattHourToJoule(energy: WattHour): Joule {
