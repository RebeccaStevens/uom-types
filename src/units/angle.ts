...
export type PlaneAngleUnit<M extends Record<string, Exponent>> =
  PlaneAngleUnitFrom<UnitMeta<M>>;
...
export type SolidAngleUnit<M extends Record<string, Exponent>> =
  SolidAngleUnitFrom<UnitMeta<M>>;
