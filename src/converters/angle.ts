...
export function radiansToDegrees(angle: Radian): Degree {
  return mul(angle, (180 / Math.PI) as UnitConversionRate<{ scalar360: 1; scalar2π: -1 }>);
}
...
export function radiansToGradians(angle: Radian): Gradian {
  return mul(angle, (200 / Math.PI) as UnitConversionRate<{ scalar400: 1; scalar2π: -1 }>);
}
...
export function degreesToRadians(angle: Degree): Radian {
  return mul(angle, (Math.PI / 180) as UnitConversionRate<{ scalar360: -1; scalar2π: 1 }>);
}
...
export function degreesToGradians(angle: Degree): Gradian {
  return mul(angle, (10 / 9) as UnitConversionRate<{ scalar360: -1; scalar400: 1 }>);
}
...
export function gradiansToRadians(angle: Gradian): Radian {
  return mul(angle, (Math.PI / 400) as UnitConversionRate<{ scalar400: -1; scalar2π: 1 }>);
}
...
export function gradiansToDegrees(angle: Gradian): Degree {
  return mul(angle, (9 / 10) as UnitConversionRate<{ scalar360: 1; scalar400: -1 }>);
}
